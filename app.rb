...
rental = Rental.new('2023-01-01', book1, person)
rental = Rental.new('2023-01-01', book2, person)
rental = Rental.new('2023-01-03', book2, person2)
rental = Rental.new('2023-02-12', book1, person3)
rental = Rental.new('2023-03-06', book1, person2)
