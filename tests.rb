...
person = Teacher.new(22, 'History', 'maximilianus')
person2 = Teacher.new(24, 'Geography', 'Julian')
person3 = Teacher.new(32, 'Universal History', 'Hanna')
# person4 = Student.new(13, 'Dean')
# person5 = Student.new(16, 'Felicia')
